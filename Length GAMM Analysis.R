...
#Load data set
load("mean_sf.length.df.analysis_int.rda")
...
GAM.check.mean_length_gam_global_smooth_plus_group_level_shared_smooth_plus_smooth_interaction_plus_random_effect.gam.check_plot<-ggplot(filter(GAM.check.mean_length_gam_global_smooth_plus_group_level_shared_smooth_plus_smooth_interaction_plus_random_effect, !(.smooth=="s(Rep)")), aes(x = exp_day, y = .estimate, fill = Fed))+
