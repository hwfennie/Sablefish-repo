...
#load dataset for PNR and weight plots
load("DFI.df.rda")
#Daily feeding incidence was calculated from ~15 individuals per treatment each day. 
#Weight was measured in groups of fish 
#We calculated mean daily weight for each treatment by first getting the mean weight of the group of fish measured, 
#then averaging groups measured in a treatment on a given day.
